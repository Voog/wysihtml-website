<div id="toolbar" class="edy-tb" style="display: none;">
  <button class="edy-tb-cmd" data-wysihtml5-command="bold" title="Bold">
  ...
  <button class="edy-tb-cmd" data-wysihtml5-command="italic" title="Italic"><svg width="21" height="21" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="edy-tb-menucontainer">
    <button class="edy-tb-act edy-tb-paragraph edy-tb-g" data-behavior="showstyles" title="Styles">
      <svg width="21" height="21" xmlns="http://www.w3.org/2000/svg">
  ...
  </button><div class="edy-reset edy-popover edy-itempicker"><div class="edy-popover-content"><div class="edy-form-group edy-tibtn-container">
    <input type="text" name="query" class="edy-form-control edy-input-large" placeholder="Type link URL here..." autocomplete="off">
    <div class="edy-itempicker-input-btns">
      <button class="edy-btn edy-btn-transparent edy-itempicker-preview" title="Preview" data-behavior="preview" style="display: none;"><svg width="25" height="25" xmlns="http://www.w3.org/2000/svg">
      <path d="M12.5 5c-5.799 0-10.5 7.5-10.5 7.5s4.702 7.5 10.5 7.5 10.5-7.5 10.5-7.5-4.701-7.5-10.5-7.5zm0 12c-2.485 0-4.5-2.015-4.5-4.5s2.014-4.5 4.5-4.5 4.5 2.015 4.5 4.5-2.015 4.5-4.5 4.5zm-.001-6.5c-1.104 0-1.999.896-1.999 2s.895 2 1.999 2 2.001-.896 2.001-2-.896-2-2.001-2z" fill="currentColor"></path>
  </svg>
  </button>
      <button class="edy-btn edy-btn-transparent edy-itempicker-clear" title="Remove" data-behavior="remove" style="display: none;"><svg width="18" height="18" xmlns="http://www.w3.org/2000/svg">
      <path d="M7.788 9l-3.108-3.108 1.212-1.212 3.108 3.108 3.108-3.108 1.212 1.212-3.108 3.108 3.108 3.108-1.212 1.212-3.108-3.108-3.108 3.108-1.212-1.212 3.108-3.108zm1.212 8c4.418 0 8-3.582 8-8s-3.582-8-8-8-8 3.582-8 8 3.582 8 8 8z" fill="currentColor"></path>
  </svg>
  </button>

      <button class="edy-btn edy-btn-large edy-btn-green" style="display: none;" data-behavior="change">Change</button>
